...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    userRole: Attribute.Enumeration<['admin', 'accountant', 'worker']>;
    firstName: Attribute.String;
    lastName: Attribute.String;
...
export interface ApiBgbServiceBgbService extends Schema.CollectionType {
  collectionName: 'bgb_services';
  info: {
    singularName: 'bgb-service';
    pluralName: 'bgb-services';
    displayName: 'BGBService';
    description: '';
  };
  options: {
...
export interface ApiConstructionConstruction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    allocatedPersons: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiDailyEntryDailyEntry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    work_entries: Attribute.Relation<
      'api::daily-entry.daily-entry',
      'oneToMany',
      'api::work-entry.work-entry'
    >;
    tenant: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    ...
    constructionId: Attribute.Integer;
...
export interface ApiPrintSettingPrintSetting extends Schema.CollectionType {
  collectionName: 'print_settings';
  info: {
    singularName: 'print-setting';
    pluralName: 'print-settings';
    displayName: 'PrintSetting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::print-setting.print-setting',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiWorkEntryWorkEntry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    daily_entry: Attribute.Relation<
      'api::work-entry.work-entry',
      'manyToOne',
      'api::daily-entry.daily-entry'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::bgb-service.bgb-service': ApiBgbServiceBgbService;
      'api::construction.construction': ApiConstructionConstruction;
      'api::daily-entry.daily-entry': ApiDailyEntryDailyEntry;
